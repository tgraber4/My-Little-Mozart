...
/**
 * Instrument strategy that applies the Acoustic Grand Piano sound.
 * Uses MIDI instrument number 0.
 */
public class AcousticGrandPianoStrategy implements InstrumentStrategy {
    
	/**
     * Applies the Acoustic Grand Piano instrument to the specified track and channel.
     *
    ...
    public void applyInstrument(Track track, int channel) {
        try {
            ...
            changeInstrument.setMessage(ShortMessage.PROGRAM_CHANGE, channel, 0, 0);
